...
По сути, когда мы говорим «интеграция» - мы подразумеваем передачу единого ключа, которы позволит одному сервису однозначно указать на объект другого сервиса. 
