...
> 🔹ЗАДАЧА
> Настроить своевременную выдачу доступов с сохранением ограничений. И распределить автоматически участников по чатам Телеграм так, чтобы по завершении курса чат для них закрылся через 10 дней.
> 
> 🔹ДАНО
